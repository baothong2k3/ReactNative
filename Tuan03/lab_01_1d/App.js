  ...
  return (
    <View
      ...
      <View
        ...
        <Text
          style={{ fontSize: 25, fontWeight: 700, textTransform: 'uppercase' }}>
          Login
        </Text>
      </View>
      <View
      ...
      <View
        ...
        <View style={[styles.viewicons, { backgroundColor: '#1593C5' }]}>
          <TouchableOpacity>
            <Text style={{ fontSize: 40, color: '#D8DFEE', fontWeight: 700 }}>
              Z
            </Text>
          </TouchableOpacity>
        </View>
        <View
          style={[
            styles.viewicons,
            { borderWidth: 1, borderColor: '#0E88D3' },
          ]}>
          <TouchableOpacity>
            <Image source={require('./icogoogle.png')} />
          </TouchableOpacity>
        </View>
      </View>
    </View>
